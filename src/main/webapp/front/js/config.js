...
var centerMenu = [
    ...
    ,{
        name: '商品收藏',
        url: '../changpianCollection/list.html'
    }
    ,{
        name: '商品订单',
        url: '../changpianOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/yinyuechanpingouwu/admin/dist/index.html#/login";
