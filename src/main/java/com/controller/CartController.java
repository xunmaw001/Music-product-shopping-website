    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                ChangpianEntity changpian = changpianService.selectById(cart.getChangpianId());
                if(changpian != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("changpian_id", cart.getChangpianId())
...
//                            cartEntity.setChangpianId(Integer.valueOf(data.get(0)));   //商品 要改的
