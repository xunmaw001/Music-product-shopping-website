...
public class ChangpianCommentbackView extends ChangpianCommentbackEntity implements Serializable {
	...
	public ChangpianCommentbackView() {

	}

	public ChangpianCommentbackView(ChangpianCommentbackEntity changpianCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, changpianCommentbackEntity);
