...
public class ChangpianCollectionView extends ChangpianCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String changpianCollectionValue;
	...
	public ChangpianCollectionView() {

	}

	public ChangpianCollectionView(ChangpianCollectionEntity changpianCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, changpianCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChangpianCollectionValue() {
				return changpianCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChangpianCollectionValue(String changpianCollectionValue) {
				this.changpianCollectionValue = changpianCollectionValue;
			}
